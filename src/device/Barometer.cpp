...
void BMP_Update()
{
    ...
    // 温度と t_fine の更新
    {
        ...
        var1 = ((((adc_T >> 3) - ((int32_t)barometer._bmp280_calib.dig_T1 << 1))) * ((int32_t)barometer._bmp280_calib.dig_T2)) >> 11;

        var2 = (((((adc_T >> 4) - ((int32_t)barometer._bmp280_calib.dig_T1)) * ((adc_T >> 4) - ((int32_t)barometer._bmp280_calib.dig_T1))) >> 12) * ((int32_t)barometer._bmp280_calib.dig_T3)) >> 14;
    ...
    // 圧力の更新
    {
        ...
        var1 = ((var1 * var1 * (int64_t)barometer._bmp280_calib.dig_P3) >> 8) + ((var1 * (int64_t)barometer._bmp280_calib.dig_P2) << 12);
        var1 =
